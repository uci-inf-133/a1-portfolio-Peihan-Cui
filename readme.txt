--Readme document for *Peihan Cui*, *peihanc@uci.edu*--
...
(a) Basic features
1. 6 images with appropriate alt texts
2. Appropriate headings and paragraphs 
3. Links to external pages (Linkedin, Github)
4. Custom icons from FontAwesome

(b) CSS features
1. Paddings and margins
2. Link, text colors, background colors are modified 
3. Using BootStrap 
4. Added custom fonts 

(c) Advanced features
1. Navigation bar on the top that jumps to the section on the page 
2. Burger menu in mobile with the collapsed navigation bar 
...
have a drop shadow and transition. 

I also used FontAwesome so I looked up icons pretty often. 
